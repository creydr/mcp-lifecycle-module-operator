...
To modify the pipelines for `mcp-lifecycle-module-operator` in the `main` branch:
...
```bash
cd pipelineruns/mcp-lifecycle-module-operator/.tekton
```
...
```bash
git commit -am "Update pipelinerun for mcp-lifecycle-module-operator (main)"
